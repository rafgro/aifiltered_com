...
<head>
  ...
  <link rel="canonical" href="./month">
  <title>Last month - AI filtered</title>
    ...
    <div class="page-right-content" id="innercontent" tabindex="0">
      <div class="content-line content-line-list">
        <div class="line-header">
          <span class="header-text">Last month, sorted by date <small>(<a href="./month">change to top score</a>)</small></span>
        </div>
        <div style="display: flex; flex-wrap: wrap; padding: 32px 10px 8px 10px;">
          <?php include('./datestream1m.php'); ?>
        </div>
      </div>
    </div>
  </div>
