  ...
  <div class="left-area hide-on-mobile">
    ...
    <div class="left-area-content">
      ...
      <a href="./cv" class="item-link" id="pageLink">
        ...
        Computer Vision</a>
      <a href="./audio" class="item-link" id="pageLink">
        <svg class="link-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder">
          <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" /></svg>
        Audio Processing</a>
  ...
  <div class="right-area">
    <div class="right-area-upper">
      ...
      <div class="search-part-wrapper">
        <div class="search-input"><!--test--></div>
    ...
    <div class="page-right-content" id="innercontent" tabindex="0">
      <div class="content-line content-line-list">
        <div class="line-header">
          <span class="header-text">About AI filtered</span>
        </div>
        <div style="padding: 32px 20px 8px 20px;">
          <p>Simple aggregator of various ML-related sources in one place:</p>
          <ul>
            <li>discussions from subreddits: r/machinelearning and (heavily filtered) r/futurology</li>
            <li><a href="http://www.arxiv-sanity.com/">Andrej Karpathy's</a>, <a href="https://paperswithcode.com/">Papers with code's</a>, and <a href="https://deepai.org">DeepAI's</a> stats on papers from arxiv</li>
            <li>articles from google news suggested in artificial intelligence section (also heavily filtered)</li>
            <li>industry blogs (DeepMind, Microsoft, Google, OpenAI) and good magazines (Synced Review, The Conversation, AI Weirdness)</li>
            <li>subjective choice of quality podcasts (TWiML, Let's Talk AI, Yannic Kilcher, Two Minute Papers, Lex Fridman) and education blogs (ML Mastery, KDnuggets, Jay Alammar, The Gradient, Distill.pub)</li>
          </ul>
          <p>How it works: each item is scored by weights given to specific sources, popularity metrics, and rough quality evaluations; then items are sorted by the score, cut for chosen timeframes, and sorted again, usually by date (in one case - last month page - original top scoring is left). No fancy ML at the moment.</p>
          <p>Categories are detected in "precision over recall" manner. They'll get better in the future!</p>
          <p>---</p>
          <p>Website was created in August 2020 by Rafał Grochala (<a href="https://twitter.com/Ivegot99introns">@Ivegot99introns</a>). Layout was designed by Aybüke Ceylan (<a href="https://codepen.io/aybukeceylan/pen/VweooYQ">codepen</a>).</p>
          <p>Current version: beta (0.6) # 5th September 2020.</p>
        </div>
      </div>
    </div>
  </div>
