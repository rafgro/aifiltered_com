...
<head>
  ...
  <title>Computer Vision - AI filtered</title>
...
<div class="app-wrapper">
  <div class="left-area hide-on-mobile">
    ...
    <div class="left-area-content">
      ...
      <a href="./cv" class="item-link active" id="pageLink">
  ...
  <div class="right-area">
    <div class="right-area-upper">
      ...
      <div class="search-part-wrapper">
        <div class="search-input">Computer Vision</div>
